...
public interface Parameters {
   ...
   // Problem Definition
    ...
    int VM_SIZE = 100;             // Number of virtual machines that <= varsize1
    double varmax = VM_SIZE - 1;  // Upper Bound of Variables -mahdoodeh fazaie search=mahdoodeh ID VMs
    double varmin = 0;            // Lower Bound of Variables-mahdoodeh fazaie search- =mahdoodeh ID VMs
    int nPop = 100;               // Number of foraging ravens     number of aza jamiat
    int MaxIt = 100;              //hade aksare tekrare algorithm number of Itterations
    //num of tasks = num of abade masale
    // *************** CSO *************//
