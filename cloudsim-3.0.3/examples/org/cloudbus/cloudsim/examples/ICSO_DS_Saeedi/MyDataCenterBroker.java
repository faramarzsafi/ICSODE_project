...
import org.cloudbus.cloudsim.examples.ICSODE_DS_Saeedi.MyTimerTask;
import org.cloudbus.cloudsim.examples.ICSODE_DS_Saeedi.Parameters;
import org.cloudbus.cloudsim.examples.ICSODE_DS_Saeedi.Chickens;
import org.cloudbus.cloudsim.examples.ICSODE_DS_Saeedi.Comparatorcost_chicken;
...
public class MyDataCenterBroker extends DatacenterBroker implements Parameters {
    ...
    public double ICSO_Algorithm() {

        varsize = varsize1 / 4;
        System.out.println();
        System.out.println("ICSO Algorithm Starting....." + "\n");
        Initialization();
        ...
        double w = 2, wmax = 0.9, wmin = 0.4, C = 0.4;
        // ********** self-learning coefficient *********** 
